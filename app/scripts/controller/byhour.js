    ...
    return function () {
            ...
            Ext.onReady(function () {
                ...
                var itemsPerPage = 50,
                    ...
                    dataForceFit = localStorage.getItem('data-byhour-forceFit');
                ...
                var adputData = Ext.create('Ext.data.Store', {
                    ...
                    proxy: {
                        type: 'jsonp',
                        url: 'http://stats.wf.com/Stats/reporthour',
                ...
                var hourOpt = [{"value":"", "name":"全部"}];
                for(var i = 0; i < 24; i++ ){
                    var value = i < 10 ?  '0' + i : i;

                    hourOpt.push({"value": value, "name":value});
                }
                var hourFields = Ext.create('Ext.data.Store', {
                    fields: ['value', 'name'],
                    data : hourOpt
                });
                        ...
                        },
                        {
                            ...
                            listeners: {
                                click: function () {
                                    ...
                                    window.open('http://stats.wf.com/Stats/reporthour?' + $.param(params));
                                }
                            }
                        },
                        {
                            ...
                            listeners: {
                                click: function (o) {
                                    ...
                                    localStorage.setItem('data-byhour-forceFit', +forceFit);
                ...
                var gridColumn = [
                    ...
                    {
                        header: '时段', dataIndex: 'hour',
                        editor: celleditor
                    },
                    {
                        header: '广告位置', dataIndex: 'posi',
                        editor: celleditor
                    },
                    {
